...
class ResNetVLBERTForPretrainingGlobal(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingGlobal, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingGlobal, self).train(mode)
    ...
    def forward(self,
        ...
        if self.config.NETWORK.WITH_MLM_LOSS:
            ...
            for i in range(num_datasets):
                ...
                # mlm_labels_list.append(mlm_labels_multi[cur_start:cur_stop])
                ...
                if self.config.NETWORK.WITH_MVRC_LOSS:
                    ...
                    outputs_dict['mlm_label_'+str(i)]=mlm_labels_list[i]
