...
class Multi30kTaskBDataset(Dataset):
    def __init__(self, ann_file, image_set, root_path, data_path, seq_len=64,
        ...
        :param kwargs:
        """
        super(Multi30kTaskBDataset, self).__init__()
        ...
        # FM: Concatenate German and English 5x caption datasets
    ...
    def __getitem__(self, index):
        ...
        # FM edit: only use one language at a time for Task B
        if idb['lang'] == 'first':
