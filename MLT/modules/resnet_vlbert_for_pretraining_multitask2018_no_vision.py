...
class ResNetVLBERTForPretrainingMultitask2018NoVision(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingMultitask2018NoVision, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingMultitask2018NoVision, self).train(mode)
