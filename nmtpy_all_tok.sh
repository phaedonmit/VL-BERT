...
echo "***************"
echo "15. ZS DEFRIMG"
nmtpy-coco-metrics -l fr "${root_path}DEFRIMG.txt" -r "${ground_path}/ENFRIMG.txt.tok"
echo "***************"
echo "16. ZS FRDEIMG"
...
nmtpy-coco-metrics -l fr "${root_path}DEFRmulti30k.txt" -r "${ground_path}/ENFRIMG.txt.tok"
echo "***************"
echo "22. NMT ZS FRDE multi30k"
nmtpy-coco-metrics -l de "${root_path}FRDEmulti30k.txt" -r "${ground_path}/ENDEIMG.txt.tok"
echo "***************"
echo "23. WMT DEFR WMT19"
nmtpy-coco-metrics -l fr "${root_path}DEFRWMT.txt" -r "${ground_path}/DEFRWMT.txt.tok"
echo "***************"
echo "24. WMT FRDE WMT19"
nmtpy-coco-metrics -l de "${root_path}FRDEWMT.txt" -r "${ground_path}/FRDEWMT.txt.tok"