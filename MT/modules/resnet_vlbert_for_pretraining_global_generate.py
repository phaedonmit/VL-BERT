...
class ResNetVLBERTForPretrainingGlobalGenerate(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingGlobalGenerate, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingGlobalGenerate, self).train(mode)
