...
class ResNetVLBERTForPretrainingTaskC(Module):
    ...
    def forward(self,
        ...
        # object_vl_embeddings = text_input_ids.new_zeros((text_input_ids.shape[0], box_mask.shape[1], 1536), dtype=torch.float)
        ...
        if self.config.NETWORK.WITH_REL_LOSS:
            ...
            relationship_logits = relationship_logits[:text_input_ids.shape[0]]
