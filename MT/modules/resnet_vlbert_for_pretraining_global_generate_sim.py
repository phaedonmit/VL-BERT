...
class ResNetVLBERTForPretrainingGlobalGenerateSim(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingGlobalGenerateSim, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingGlobalGenerateSim, self).train(mode)
    ...
    def forward(self,
        ...
        curr_len = 0
        max_len = 150
        # initialise step (how many source tokens to allow show starting)
        step = 1
        text_input_ids_master = text_input_ids.deepcopy()
        text_token_type_ids_master = text_token_type_ids.deepcopy()
        text_visual_embeddings_master = text_visual_embeddings.deepcopy()
        text_mask_master = text_mask.deepcopy()
