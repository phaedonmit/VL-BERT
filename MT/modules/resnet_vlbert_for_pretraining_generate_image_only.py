...
class ResNetVLBERTForPretrainingGenerateImageOnly(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingGenerateImageOnly, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingGenerateImageOnly, self).train(mode)
