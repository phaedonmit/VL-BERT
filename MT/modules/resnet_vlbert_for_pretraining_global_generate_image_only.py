...
class ResNetVLBERTForPretrainingGlobalGenerateImageOnly(Module):
    def __init__(self, config):

        super(ResNetVLBERTForPretrainingGlobalGenerateImageOnly, self).__init__(config)
    ...
    def train(self, mode=True):
        super(ResNetVLBERTForPretrainingGlobalGenerateImageOnly, self).train(mode)
