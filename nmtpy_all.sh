...
echo "***************"
echo "3. TUIMG"
nmtpy-coco-metrics -l en "${root_path}TUIMG.txt" -r "${ground_path}TUIMG_0.txt" "${ground_path}TUIMG_1.txt"
echo "***************"
echo "4. DEENIMG"
...
echo "***************"
echo "11. ENTU"
nmtpy-coco-metrics -l en "${root_path}ENTU.txt" -r "${ground_path}ENTU.txt"
echo "***************"
echo "12. FREN"
...
echo "***************"
echo "14. ZS FRIMG"
nmtpy-coco-metrics -l fr "${root_path}FRIMG.txt" -r "${ground_path}ENFRIMG.txt"
echo "***************"
echo "15. ZS DEFRIMG"
nmtpy-coco-metrics -l de "${root_path}DEFRIMG.txt" -r "${ground_path}ENFRIMG.txt"
echo "***************"
echo "16. ZS FRDEIMG"
nmtpy-coco-metrics -l de "${root_path}FRDEIMG.txt" -r "${ground_path}ENDEIMG.txt"
